<template>
  <div class="grid-container" style="padding-top: 0px; padding-bottom: 0px">
    <div
      ...
      style="padding-top: 0px; padding-bottom: 0px; padding: 0px"
    >
          ...
          <div class="body" v-show="show">
            <div class="body-inner">
              <slot>
                  ...
                  >
                    <div class>
                      ...
                      <label
                        class="label_name"
                        :class="
                          (isMouseLeaveCompany && Company != '') ||
                          (!isMouseFocusCompany && Company != '')
                            ? 'mouseLeave_'
                            : ''
                        "
                        >Company*:</label
                  ...
                  >
                    <div class>
                      ...
                      <label
                        class="label_name"
                        :class="
                          (isMouseLeavePosition && Position != '') ||
                          (!isMouseFocusPosition && Position != '')
                            ? 'mouseLeave_'
                            : ''
                        "
                        >Position*:</label
                  ...
                  >
                    <div class>
                      <input
                        ...
                        class="input"
                        :class="
                          isMouseLeavePositionClassification
                            ? 'mouseLeave'
                            : isMouseFocusPositionClassification
                            ? 'input'
                            : ''
                        "
                  ...
                  >
                    <div class>
                      ...
                      <label
                        class="label_name"
                        :class="
                          (isMouseLeaveCity && City != '') ||
                          (!isMouseFocusCity && City != '')
                            ? 'mouseLeave_'
                            : ''
                        "
                        >City*:</label
                      ...
                      <div class>
                        ...
                        <label
                          ...
                          :class="
                            !month
                              ? 'unselected'
                              : (isMouseLeaveMonth && month != 0) ||
                                (!isMouseFocusMonth && month != 0)
                              ? 'mouseLeave_'
                              : ''
                          "
                          >Month:</label
                      ...
                      <div class>
                        ...
                        <label
                          ...
                          :class="
                            !year
                              ? 'unselected'
                              : (isMouseLeaveYear && year != 0) ||
                                (!isMouseFocusYear && year != 0)
                              ? 'mouseLeave_'
                              : ''
                          "
                          >Year:</label
                      ...
                      <div class>
                        ...
                        <label
                          ...
                          :class="
                            !month_
                              ? 'unselected'
                              : (isMouseLeaveMonth_ && month_ != 0) ||
                                (!isMouseFocusMonth_ && month_ != 0)
                              ? 'mouseLeave_'
                              : ''
                          "
                          >Month:</label
                      ...
                      <div class>
                        ...
                        <label
                          ...
                          :class="
                            !year_
                              ? 'unselected'
                              : (isMouseLeaveYear_ && year_ != 0) ||
                                (!isMouseFocusYear_ && year_ != 0)
                              ? 'mouseLeave_'
                              : ''
                          "
                          >Year:</label
                ...
                <div
                  class="confirm"
                  style="margin-bottom: 32px; margin-top: -4px"
                >
                  <i
