<template>
  <div>
    <section class="page-resume-editor page-login-info mt-15">
      <div class="container">
        <div class="row">
            ...
            <div class="resume-editor-div" style="padding: 34px 25px">
              ...
              <div class="login_input_field" v-if="!errors">
                ...
                <span
                  ...
                  <div
                    ...
                    class="tooltip"
                    :style="[
                      passTipOpen ? { visibility: 'visible !important' } : '',
                    ]"
                    style="
                      position: absolute;
              ...
              <div class="login_input_field" v-if="!errors">
                ...
                <label
                  class="label_name label_name_color"
                  :class="
                    isMouseLeaveConfirmPassword && confirmPassword != ''
                      ? 'mouseleavefill'
                      : ''
                  "
    ...
    insertData: function () {
      ...
      if (this.password != "" && this.confirmPassword != "") {
        if (this.password !== this.confirmPassword) {
          ...
          window.axios
            .post(
              this.EnvPath + "auth/reset_password",
