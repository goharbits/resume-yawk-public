            ...
            <div class="resume-editor-div">
              ...
              >
                ...
                >
                  ...
                  >
                    <span class="plus_part">Plus</span>Functional
                    <span
                  ...
                  <a
                    href="#"
                    class="see_example_link see_example_link_first"
                    style="padding: 5px 60px 5px 0px; color: #d3d3d3"
                    >See example</a
                  >
                  <a
                    href="#"
                    style="color: #d3d3d3; padding: 5px 0px 5px 80px"
                    class="see_example_link"
                    >See example</a
                  >
                </div>
