    ...
    <div class="row">
        ...
        <div class="col-md-10 grid-container">
          <div class="section-height-footer">
            <div class="resume-editor-div resume-editor-firefox w-100 popup-align-center-box" >
                <h2>
                  <span class="icon">
              ...
              <twobuttonmodel :popupHeight="p_height" popupTitle="Are You Sure?" popupText="It looks like you haven't entered any education. If you are currently in school, you can add the education and put your expected graduation date. If you aren't in school, sometimes the best education is school of hard knocks." v-if="showedunextModal" @close="closeedunextModal" @proceed="proceededunextModel" ></twobuttonmodel>
              <twobuttonmodel :popupHeight="p_height" popupTitle="Do you want to proceed?" popupText="You have not completed all of the required fields. If you proceed then you will cancel creating a new record. Do you want to continue?" v-if="showModal" @close="closeModal" @proceed="proceedModel" ></twobuttonmodel>
              <twobuttonmodel :popupHeight="p_height" popupTitle="Are you Sure You Want to Delete?" popupText="I'm sure you worked hard for this education. Are you sure you just want to throw it away with the click of a button?" v-if="showdelModal" @close="closedelModal" @proceed="proceeddelModel" ></twobuttonmodel>
              <twobuttonmodel :popupHeight="p_height" popupTitle="Are you Sure You Want to Update?" popupText="This change will effect your resume builder page. Are you sure you just want to update it with the click of a button?" v-if="showResumeAlertPopup" @close="closeResumeModal" @proceed="proceedUpdateModel" ></twobuttonmodel>
                  <input type="hidden" name="update" v-model="updateIndex">
                <div v-for="(education_line,index) in education_lines" v-bind:key="index"  class="accordion purple"> <!-- id="accordion" -->
                    <div @click="showEducationEdit(education_line.show,index)" class="header">
                        <slot name="header">
                            <div slot="header"
                                 style="word-break: break-all; font-family:'Hind', sans-serif; font-size: 18px; color: #767676;padding-top:2px;text-align:left; ">
                            ...
                            <div class="body-inner">
                                <slot>
                                    ...
                                    <div class="row justify-content-center"
                                        ...
                                        <div class=" col-md-12 col-sm-12 group mr-2 inputP55 space-adjust-education-box"
                                             style="height: 50px;margin-top: 30px; margin-bottom: 20px;">
                                            <div class="autocomplete w-100">
                                                <input maxlength="70" ref="School" autocomplete="off" v-on:blur="mouseLeaveInputEducation('School',index)" type="text" v-model="education_line.School" class="input"
                                                ...
                                                <span class="bar"></span>
                                                <label class="label_name align-school-feild-text" :class="(education_line.isMouseLeaveSchool && (education_line.School!='') || (!education_line.isMouseFocusSchool && (education_line.School!='')))?'mouseLeave_':''">School*:</label>
                                            </div>
                                                <div
                                                  class="school-tooltip"
                                                  data-tooltip="Select from our list of US schools or type your school in manullay"
                                                >
                                                  <img
                                          ...
                                          <span>
                                            <img :src="EnvPath+'images/bg/help.png'" alt class="small_logo yak-logo" v-tooltip="field_educationschool"/>
                                          </span>
                                    ...
                                    <div class="row justify-content-center margin-bottom-remove-from-tablet"
                                         style="padding-left: 10px;padding-right: 10px;margin-bottom: 23px;">
                                        <div class="col-md-4 col-sm-12 group mr-2 inputP55 mb-mb-10 space-on-education-feilds" style="height: 50px;">
                                            <div class>
                                                <input maxlength="50" v-on:blur="mouseLeaveInputEducation('city',index)" type="text" v-model="education_line.City" class="input"
                                        ...
                                        <div class="col-md-4 col-sm-12 group mr-2 inputP55 mb-mb-10 space-on-education-feilds" style="height: 50px;">
                                            <div class="select-arrow-side" :class="(arrowTrue == 'state') ? 'arrowUp' : ''" v-if="education_line.showStateSelect">
                                    ...
                                    <!-- end .row -->
                                    <div class="row justify-content-center margin-bottom-box" style="padding-left: 10px; padding-right: 10px;margin-bottom: 23px;">
                                        <div class="col-md-4 col-lg-4 col-sm-12 group mr-2 inputP55 mb-mb-10" style="height: 50px;margin-top: 3px;">
                                            <div class="select-arrow-side degree-side-arrow" :class="(arrowTrue == 'degree') ? 'arrowUp' : ''">
                                          ...
                                          <span>
                                            <img :src="EnvPath+'images/bg/help.png'" alt class="small_logo yak-logo" v-tooltip="field_educationdegree"/>
                                          </span>
                                        </div>

                                        <div v-if="education_line.showOtherDegree" class=" col-md-4 col-lg-4 col-sm-12 group mr-2 inputP55" style="height: 50px; margin-top: 3px;">
                                          <div class="other-degree-label-red">
                                            ...
                                            <!-- <span class="highlight"></span> -->
                                            <span class="bar"></span>
                                            <label class="label_name padding-left-label-space"
                                      :class="(education_line.isMouseLeaveOtherDegree && (education_line.OtherDegree != '')
                                       || (!education_line.isMouseFocusOtherDegree && (education_line.OtherDegree != ''))) ?
                                        'mouseLeave_':''">Other Degree*:</label>
                                          </div>
                                        </div>

                                        <div  class="col-md-4 col-lg-4 col-sm-12 group mr-2 inputP55" style="height: 50px; margin-top: 3px;">
                                            <div v-if="education_line.showMajorField" class>
                                                ...
                                                <!-- <span class="highlight"></span> -->
                                                <span class="bar"></span>
                                                <label class="label_name text-left-control-space"
                                        ...
                                        <div  v-if="education_line.showOtherDegree != true" class="col-md-4 col-sm-8 group mr-2 inputP55 credit-compkete-number" style="height: 50px; margin-top: 3px;">
                                          <div v-if="education_line.showCreditCompleted" class>
                                            <input type="text" v-model="education_line.CreditCompleted" class="input" maxlength="4"
                                    ...
                                    <div class="row justify-content-center" style="padding-left: 10px;padding-right: 10px; margin-bottom: -7px;">
                                        <div class="col-md-4 col-sm-12 workdate space-control-left-text">
                                            <p class="graduation-date" style="font-family: Hind; font-size:16px; color:#767676; align-items:center">{{Graduation_Lable}}:</p>
                                        </div>
                                        <div class="col-md-4 inputP55 mt-mb">
                                            <div class="select-arrow-side yawk-image-arrow arrow-control-down month-input-select" :class="(arrowTrue == 'month') ? 'arrowUp' : ''">
                                          ...
                                          <span>
                                            ...
                                            <img v-else :src="EnvPath+'images/bg/help.png'" alt class="small_logo yak-logo" v-tooltip="field_educationgradmonth"/>
                                          </span>
                                        </div>
                                        <div class="col-md-4 mb-mb-15 year inputP55 yawk-head-tooltip tooltip-on-mobile-yawk-head" style="height:50px">
                                            <div class="select-arrow-side yawk-image-arrow month-input-select" :class="(arrowTrue == 'year') ? 'arrowUp' : ''">
                                          ...
                                          <span>
                                            <img v-if="Graduation_Lable == 'Date Last Attended'" :src="EnvPath+'images/bg/help.png'" alt class="small_logo yak-logo" v-tooltip="field_educationGradYearLastAttendedDate"/>
                                            <img v-else :src="EnvPath+'images/bg/help.png'" alt class="small_logo yak-logo" v-tooltip="field_educationgradyear"/>
                                          </span>
                                        </div>
                                    </div>
                                    <div class="confirm space-edu-back align-icons-box">
                                      <!-- data-target="#exampleModal" -->
                                        <i v-if="education_line.db_education_id != 0" class="fa fa-2x fa fa-trash header-icon1 hover-icon-del space-bottom-align-icons space-left-phone-align-icon" data-toggle="modal" @click="deleteEducation(index)"
                                           style="display: inline; position: absolute; left: 45px; cursor:pointer;"></i>
                                          <i  class="fa fa-times-circle hover-icon-work-history space-bottom-align-icons" style="font-size:30px;color:#fb643e;position: absolute;right: 85px; cursor:pointer;"
                                           @click="cancel(index)"></i>

                                           <i v-if="education_line.db_education_id != 0"  class="fa fa-check-circle hover-icon-work-history space-bottom-align-icons" style="font-size:30px;color:#fb643e;position: absolute;right: 50px; cursor:pointer;"
                                           @click="IsNextEducation(false,false,index,true)"></i>

                                           <i v-else class="fa fa-check-circle hover-icon-work-history space-bottom-align-icons" style="font-size:30px;color:#fb643e;position: absolute;right: 50px; cursor:pointer;"
                                           @click="IsNextEducation(false,false,index,false)"></i>
                                    </div>
                                </slot>
                            </div>
                        </div>
                ...
                <button type="button" class="btn btn-block add-new-block" @click="wh_IsNextEducation(false,true)" style="border: 3px solid #e6e6e6; color: #c8c8c8; padding: 11px 0px; font-size: 18px; border-radius: 6px;">+Add New</button>
              ...
              <p v-if="errors.length">
                ...
                <div class="text-center">
                    <button class="btn1 btn-rounded btn-next mt-4 btn-text-arrow-right"  @click="wh_IsNextEducation(true,false)">Next
...
export default {
  ...
  data() {
    return {
      ...
      field_educationGradYearLastAttendedDate:
        "Add the date you last attended this school. If you are still attending this school, then change your degree to the degree you expect to earn.",
      Gotonext: "",
      Addnew: "",
      Index: "",
    };
  ...
  mounted() {
    store.commit("storeCurrentPage", 3);
  ...
  methods: {
        ...
        window.axios
          .post(
            ...
            querystring.stringify({
              ...
              master_school_id:
                this.education_lines[this.Index].master_school_id,
              ...
              b4_CreditCompleted:
                this.education_lines[this.Index].b4_CreditCompleted,
              Page: page,
            })
          )
          .then(({ data }) => {
            if (data.status == 1) {
              ...
              if (this.Gotonext) {
                ...
                this.education_lines[this.Index].b4_master_school_id =
                  this.education_lines[this.Index].master_school_id;
                this.education_lines[this.Index].b4_School =
                  this.education_lines[this.Index].School;
                this.education_lines[this.Index].b4_City =
                  this.education_lines[this.Index].City;
                this.education_lines[this.Index].b4_state =
                  this.education_lines[this.Index].state;
                this.education_lines[this.Index].b4_country =
                  this.education_lines[this.Index].country;
                this.education_lines[this.Index].b4_degree =
                  this.education_lines[this.Index].degree;
                this.education_lines[this.Index].b4_MajorField =
                  this.education_lines[this.Index].MajorField;
                this.education_lines[this.Index].b4_month =
                  this.education_lines[this.Index].month;
                this.education_lines[this.Index].b4_year =
                  this.education_lines[this.Index].year;
    ...
    proceedUpdateModel() {
      ...
      this.IsNextEducation(false, false, index, false);
    },
    proceeddelModel() {
    ...
    closeModal() {
      ...
      this.showResumeAlertPopup = false;
      this.v_next(false);
    },
    closeResumeModal() {
      this.showResumeAlertPopup = false;
    ...
    load_education_history: function () {
      axios.get(this.EnvPath + "educationhistory").then(({ data }) => {
        if (data.status == 1) {
          ...
          console.log("education_History", this.$store.state.education_History);
          for (let i = 0; i < this.$store.state.education_History.length; i++) {
            this.education_lines.push({
              master_school_id:
                this.$store.state.education_History[i].school_id,
              ...
              education_head:
                ...
                ", " +
                this.degrees[this.$store.state.education_History[i].degree - 1],
              show: false,
            });
            ...
            if (this.$store.state.education_History[i].degree == 16) {
              this.education_lines[i].b4_CreditCompleted =
                this.$store.state.education_History[i].credits_completed;
    ...
    delete_education_history: function (index) {
      ...
      window.axios
        .delete(this.EnvPath + "educationhistory", {
          data: {
    ...
    mouseLeaveInputEducation(inputName, index) {
      ...
      if (inputName === "OtherDegree") {
        this.education_lines[index].isMouseLeaveOtherDegree = true;
        this.education_lines[index].isMouseFocusOtherDegree = false;
      }
    ...
    inputFocusEducation(inputName, index) {
      ...
      if (inputName === "OtherDegree") {
        this.education_lines[index].isMouseFocusOtherDegree = true;
        this.education_lines[index].isMouseLeaveOtherDegree = false;
      }
      if (inputName === "degree") {
    ...
    IsNextEducation(gotonext, addnew, index, edit = null) {
      if (
        this.education_lines[index].School != "" &&
        this.education_lines[index].City != "" &&
        this.education_lines[index].state != "" &&
        ...
        if (nodateerror) {
          ...
          if (
            Year >= Form_year &&
            this.education_lines[index].showCreditCompleted
          ) {
            if (Month >= Form_month) {
          ...
          window.axios
            .post(
              ...
              querystring.stringify({
                ...
                b4_CreditCompleted:
                  this.education_lines[index].b4_CreditCompleted,
                Page: page,
              })
            )
            .then(({ data }) => {
              if (data.status == 1) {
                ...
                if (gotonext) {
                  ...
                  this.education_lines[index].b4_master_school_id =
                    this.education_lines[index].master_school_id;
                  this.education_lines[index].b4_School =
                    this.education_lines[index].School;
                  this.education_lines[index].b4_City =
                    this.education_lines[index].City;
                  this.education_lines[index].b4_state =
                    this.education_lines[index].state;
                  this.education_lines[index].b4_country =
                    this.education_lines[index].country;
                  this.education_lines[index].b4_degree =
                    this.education_lines[index].degree;
                  this.education_lines[index].b4_MajorField =
                    this.education_lines[index].MajorField;
                  this.education_lines[index].b4_month =
                    this.education_lines[index].month;
                  this.education_lines[index].b4_year =
                    this.education_lines[index].year;
    ...
    showPopUpForResume: function (index) {
      this.updateIndex = index;
      this.showResumeAlertPopup = true;
    },
    toggle: function () {
      this.show = !this.show;
    },
...
.select-arrow-side.degree-side-arrow:before {
