...
function addMinorField() {
  ...
  $(".edu_fields_section_more").append(
    "<div class='minor-field-section no_label_left' style='margin-left: 108px;'><input type='text' value='' name='minor-field-" +
    x +
    "' class='minor-text-field' onKeyPress='if(event.keyCode==13){addMinorField();}' /><span class='icon remove_minor_field'><i class='fa fa-minus'></i></span></div></div>"
  ); //add input field
  // }
}
...
$(document).ready(function () {
  ...
  $(".add_more_hononrs_fields").click(function (e) {
    //click event on add more fields button having class add_more_button
    e.preventDefault();
    //if(x < max_fields_limit){ //check conditions
    addHonorsField();
  ...
  $(".edu_honors_fields_more").on("click", ".remove_honor_field", function (e) {
    //user click on remove text links
    e.preventDefault();
    $(this).parent("div").remove();
    y--;
...
function addHonorsField() {
  y++; //counter increment
  $(".edu_honors_fields_more").append(
    "<div class='minor-field-section' style='width:100%;'><input type='text' value='' name='honor-field-" +
    y +
    "' class='minor-text-field' onKeyPress='if(event.keyCode==13){addHonorsField();}' /><span class='icon remove_honor_field'><i class='fa fa-minus'></i></span></div></div>"
  ); //add input field
}
...
$(document).ready(function () {
  //var max_fields_limit      = 8; //set limit for maximum input fields
  var x = 1; //initialize counter for text box
  $(".add_more_socities_fields").click(function (e) {
    //click event on add more fields button having class add_more_button
    e.preventDefault();
    //if(x < max_fields_limit){ //check conditions
    addSocitiesField();
...
function addSocitiesField() {
  z++; //counter increment
  $(".edu_socities_fields_more").append(
    "<div class='minor-field-section' style='width:100%;'><input type='text' value='' name='society-field-" +
    z +
    "' class='minor-text-field' onKeyPress='if(event.keyCode==13){addSocitiesField();}' /><span class='icon remove_socity_field'><i class='fa fa-minus'></i></span></div></div>"
  ); //add input field
}
...
$(document).ready(function () {
  //var max_fields_limit      = 8; //set limit for maximum input fields
  var x = 1; //initialize counter for text box
  $(".add_more_honors_awards_fields").click(function (e) {
    //click event on add more fields button having class add_more_button
    e.preventDefault();
    //if(x < max_fields_limit){ //check conditions
    x++; //counter increment

    $(".honours_award_section_more").append(
      "<div class='new_more_fields'><div class='col-5 left_more_fields'><select name='job_name_" +
      x +
      "' class='select-item select-item-job-name' style='-webkit-appearance: none;'><option value='0' class='label_name'>Type</option></select></div><div class='col-7 minor-field-section right_field_more'><input type='text' value='' name='minor-field-" +
      x +
      "' class='minor-text-field' /><span class='icon icon-minus remove_honors_awards_fields'><i class='fa fa-minus'></i></span></div></div>"
    ); //add input field
    // }
  });
  $(".honours_award_section_more").on(
    "click",
    ".remove_honors_awards_fields",
    function (e) {
      //user click on remove text links
      e.preventDefault();
...
$(document).ready(function () {
  //var max_fields_limit      = 8; //set limit for maximum input fields
  var x = 1; //initialize counter for text box
  $(".add_more_licensese_certificare_fields").click(function (e) {
    //click event on add more fields button having class add_more_button
    e.preventDefault();
    //if(x < max_fields_limit){ //check conditions
    x++; //counter increment

    $(".licensese_certificare_section_more").append(
      "<div class='new_more_fields'><div class='col-5 left_more_fields'><select name='job_name_" +
      x +
      "' class='select-item select-item-job-name' style='-webkit-appearance: none;'><option value='0' class='label_name'>Type</option></select></div><div class='col-7 minor-field-section right_field_more'><input type='text' value='' name='minor-field-" +
      x +
      "' class='minor-text-field' /><span class='icon icon-minus remove_licensese_certificare_fields'><i class='fa fa-minus'></i></span></div></div>"
    ); //add input field
    // }
  });
  $(".licensese_certificare_section_more").on(
    "click",
    ".remove_licensese_certificare_fields",
    function (e) {
      //user click on remove text links
      e.preventDefault();
      $(this).parent("div").parent("div").remove();
...
$(document).ready(function () {
  //var max_fields_limit      = 8; //set limit for maximum input fields
  var x = 1; //initialize counter for text box
  $(".add_more_professional_civil_fields").click(function (e) {
    //click event on add more fields button having class add_more_button
    e.preventDefault();
    //if(x < max_fields_limit){ //check conditions
    x++; //counter increment

    $(".professional_civil_section_more").append(
      "<div class='new_more_fields'><div class='col-5 left_more_fields'><select name='job_name_" +
      x +
      "' class='select-item select-item-job-name' style='-webkit-appearance: none;'><option value='0' class='label_name'>Type</option></select></div><div class='col-7 minor-field-section right_field_more'><input type='text' value='' name='minor-field-" +
      x +
      "' class='minor-text-field' /><span class='icon icon-minus remove_professional_civil_fields'><i class='fa fa-minus'></i></span></div></div>"
    ); //add input field
    // }
  });
  $(".professional_civil_section_more").on(
    "click",
    ".remove_professional_civil_fields",
    function (e) {
      //user click on remove text links
      e.preventDefault();
      $(this).parent("div").parent("div").remove();
...
$(document).ready(function () {
  //var max_fields_limit      = 8; //set limit for maximum input fields
  var x = 1; //initialize counter for text box
  $(".add_more_publicition_fields").click(function (e) {
    //click event on add more fields button having class add_more_button
    e.preventDefault();
    //if(x < max_fields_limit){ //check conditions
    x++; //counter increment

    $(".publicition_section_more").append(
      "<div class='minor-field-section' style='width:100%;'><div class='publications_fields_left'><p>Citation</p><input type='text' name='pub-field-" +
      x +
      "' class='minor-text-field' /><div class='job_name_finder'><select name='type_pub_" +
      x +
      "' class='select-item select-item-job-name input mouseLeave' style='-webkit-appearance: none;'><option value='0' class='label_name'>Type</option></select></div></div><div class='publication_icon_more'><span class='icon icon-minus remove_publicition_fields'><i class='fa fa-minus'></i></span></div></div>"
    ); //add input field
    // }
  });
  $(".publicition_section_more").on(
    "click",
    ".remove_publicition_fields",
    function (e) {
      //user click on remove text links
      e.preventDefault();
      $(this).parent("div").parent("div").remove();
...
$(document).ready(function () {
  //var max_fields_limit      = 8; //set limit for maximum input fields
  var x = 1; //initialize counter for text box
  $(".add_more_patents_fields").click(function (e) {
    //click event on add more fields button having class add_more_button
    e.preventDefault();
    //if(x < max_fields_limit){ //check conditions
    x++; //counter increment

    $(".patents_section_more").append(
      "<div class='minor-field-section' style='width:100%;'><div class='publications_fields_left'><p>Patent Title</p><input type='text' name='patents-title-field-" +
      x +
      "' class='minor-text-field' /><p>Patent Holders</p><input type='text' name='patents-holder-field-" +
      x +
      "' class='minor-text-field' /><div class='job_name_finder'><select name='type_patents_" +
      x +
      "' class='select-item select-item-job-name input mouseLeave' style='-webkit-appearance: none;'><option value='0' class='label_name'>Type</option></select></div></div><div class='publication_icon_more'><span class='icon icon-minus remove_patents_fields'><i class='fa fa-minus'></i></span></div></div>"
    ); //add input field
    // }
  });
  $(".patents_section_more").on(
    "click",
    ".remove_patents_fields",
    function (e) {
      //user click on remove text links
      e.preventDefault();
      $(this).parent("div").parent("div").remove();
...
// $(document).ready(function() {
//   $(".add_new_resume_field").click(function(e) {
//     //click event on add more fields button having class add_more_button
//     e.preventDefault();
