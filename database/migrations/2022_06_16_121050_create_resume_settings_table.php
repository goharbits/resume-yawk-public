...
class CreateResumeSettingsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('resume_settings', function (Blueprint $table) {
            ...
            $table->boolean('is_edu_month_year')->default(true);
            $table->boolean('is_edu_year')->default(false);
            $table->boolean('is_edu_dates')->default(true);
            $table->boolean('is_edu_city_state_country')->default(true);
            $table->boolean('is_edu_city_state')->default(false);
            $table->boolean('is_edu_location')->default(true);
            ...
            $table->boolean('is_info_full_address_city')->default(true);
            $table->boolean('is_info_full_address')->default(false);
            $table->boolean('is_info_city_state')->default(false);
            $table->boolean('is_info_location')->default(true);
            $table->timestamps();
        });
    }
